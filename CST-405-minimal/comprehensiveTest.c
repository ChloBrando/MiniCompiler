...
int globalCounter;    /* Global counter variable */
int globalArray[20];  /* Global array for testing */
int globalResult;     /* Global result storage */
...
# testArithmetic(int a, int b) {
    ...
    int diff;    /* Difference of a and b */
    int prod;    /* Product of a and b */
    int quot;    /* Quotient of a and b */
    int complex; /* Complex expression result */
...
# testNestedLoops(int rows, int cols) {
    int total;  /* Total count accumulator */
...
/* ========================================
   ALGORITHM TESTING (GCD, SEARCH, SORT)
   ======================================== */
...
/* ========================================
   MAIN PROGRAM - COMPREHENSIVE TESTING
   ======================================== */
